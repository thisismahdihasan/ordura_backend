...
export const reviewPaths: OpenApiPathMap = {
  ...
  "/api/v1/workspaces/{workspaceId}/reviews/{reviewId}": {
    get: {
      ...
      description: "ADMIN may read any workspace review. DESIGNER may read only an item for which they are the current assigned designer. Rounds are ascending by round number; annotations and replies are ascending by creation time. Historical images may be unavailable when imageDeletedAt is set.",
